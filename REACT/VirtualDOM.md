...
브라우저의 랜더링 방법에 대해 간단히 살펴보면서 위의 DOM 렌더링 문제에 대해 알아보자. 아래는 브라우저 렌더링 과정을 그림을 나타낸 것이다.
...
이런 경우는 리액트는 첫 번째 리스트가 강아지에서 거북이로 바뀐 것을 알아채고 li의 모든 요소를 새로 랜더링 한다. 이를 해결하기 위해 key props를 통해 해결할 수 있다.
...
[DOM의 개념](http://www.tcpschool.com/javascript/js\_dom\_concept)\
