# 배열의 요소 추가 삭제(push, pop, unshift, shift, splice, slice, concat)
...
- **특징**: 배열의 기존 요소를 삭제 또는 교체하거나 새 요소를 추가하여 원본 배열의 내용을 변경
...
[👆](#배열의-요소-추가-삭제push-pop-unshift-shift-splice-slice-concat)
