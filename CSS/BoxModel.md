...
![content, padding, border, margin](../image/CSS/BoxModel2.png) ![styled](../image/CSS/BoxModel3.png)
...
만일 width와 height로 지정한 콘텐츠 영역보다 실제 콘텐츠가 크면 콘텐츠 영역을 넘치게 된다. `overflow:hidden;`을 지정하면 넘친 콘텐츠를 감출 수 있다.
...
![margin / padding](../image/CSS/marginpadding.png)
